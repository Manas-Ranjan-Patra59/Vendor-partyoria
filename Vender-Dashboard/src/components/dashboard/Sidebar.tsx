...
import { Home, Calendar, Star, BarChart3, FileCheck, BookOpen, MessageCircle, Settings, User, Users, LogOut, UserCog } from "lucide-react";
...
const menuItems = [
  ...
  { path: "/dashboard/verification", label: "Verification", icon: FileCheck },
];
